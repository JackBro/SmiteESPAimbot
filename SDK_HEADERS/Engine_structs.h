...
struct FImpactInfo
{
	...
	unsigned char                                      nFiringInstance;                                  		// 0x005C (0x0001) [0x0000000000100000]              
};
...
struct FTexture2DMipMap
{
	...
	struct FName                                       FileNameOverride;                                 		// 0x003C (0x0008) [0x0000000000001000]              ( CPF_Native )
};
...
{
	struct FPostProcessSettings                        Settings;                                         		// 0x0000 (0x016C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      bBlendingIn : 1;                                  		// 0x016C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bBlendingOut : 1;                                 		// 0x016C (0x0004) [0x0000000000000000] [0x00000002] 
	float                                              CurrentBlendInTime;                               		// 0x0170 (0x0004) [0x0000000000000000]              
	float                                              CurrentBlendOutTime;                              		// 0x0174 (0x0004) [0x0000000000000000]              
	float                                              BlendInDuration;                                  		// 0x0178 (0x0004) [0x0000000000000000]              
	float                                              BlendOutDuration;                                 		// 0x017C (0x0004) [0x0000000000000000]              
	float                                              BlendStartTime;                                   		// 0x0180 (0x0004) [0x0000000000000000]              
	struct FInterpCurveFloat                           TimeAlphaCurve;                                   		// 0x0184 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	struct FPostProcessSettings                        LastSettings;                                     		// 0x0000 (0x016C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class APostProcessVolume*                          LastVolumeUsed;                                   		// 0x016C (0x0004) [0x0000000000000000]              
...
struct FSoundClassProperties
{
	...
	struct FName                                       m_nmSoundMode;                                    		// 0x0020 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	float                                              m_fNonLocalPriorityBoost;                         		// 0x0028 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              m_fLocalPriorityBoost;                            		// 0x002C (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
